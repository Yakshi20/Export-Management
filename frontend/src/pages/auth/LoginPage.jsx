        ...
        <div className="bg-white rounded-2xl shadow-xl border border-[#e0e4f0] p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input type="email" value={form.email} onChange={e => setForm({ ...form, email: e.target.value })} placeholder="your@email.com" required className="w-full border border-[#d0d5ee] rounded-xl px-4 py-2.5 text-[#1a1a2e] focus:outline-none focus:border-[#6366f1] bg-white text-sm" />
            </div>
            <div>
              <label className="text-sm font-medium text-[#1a1a2e] mb-1 block">Password</label>
              <input type="password" value={form.password} onChange={e => setForm({ ...form, password: e.target.value })} placeholder="........" required className="w-full border border-[#d0d5ee] rounded-xl px-4 py-2.5 text-[#1a1a2e] focus:outline-none focus:border-[#6366f1] bg-white text-sm" />
            </div>
